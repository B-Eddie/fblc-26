...
import { ArrowLeft, Upload, AlertCircle, Plus, Trash2 } from "lucide-react";
      ...
      <main className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="text-xs text-gray-500 mb-4">
                Add custom questions that applicants will need to answer when applying. You can also add more questions later.
              </p>
        ...
        >
          ...
          <ul className="space-y-3 text-gray-300">
            ...
            <li className="flex items-start space-x-3">
              <span className="text-gray-600 mt-0.5">•</span>
              <span>Include perks or benefits to attract more applicants</span>
            </li>
            <li className="flex items-start space-x-3">
              <span className="text-gray-600 mt-0.5">•</span>
              <span>Set realistic dates and hour commitments</span>
            </li>
          </ul>
        </motion.div>
      </main>
